...
if (args[0] === undefined) {
  ...
  (0, _mdLinks.mdLinks)(args[0]).then(function (result) {
    result.forEach(function (link) {
      console.log((0, _templates.templateLinks)(link));
    });
  });
  ...
  (0, _mdLinks.mdLinks)(args[0], {
    ...
    console.log('1', (0, _templates.templateStatsValidate)((0, _stats.brokeLinks)((0, _stats.statsLinks)(result), result)));
  });
} else if ((args[1] === '--stats' || args[1] === '--s') && (args[2] === '--validate' || args[2] === '--v')) {
  (0, _mdLinks.mdLinks)(args[0], {
    validate: true
  }).then(function (result) {
    console.log('2', (0, _templates.templateStatsValidate)((0, _stats.brokeLinks)((0, _stats.statsLinks)(result), result)));
  });
} else if (args[1] === '--stats' || args[1] === '--s') {
  (0, _mdLinks.mdLinks)(args[0]).then(function (result) {
    console.log('3', (0, _templates.templateStats)((0, _stats.statsLinks)(result)));
  });
  ...
  (0, _mdLinks.mdLinks)(args[0], {
    ...
    result.forEach(function (link) {
      console.log('4', (0, _templates.templateValidate)(link));
    });
  });
} else {
  console.log('Error');
